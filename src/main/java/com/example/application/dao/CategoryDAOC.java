...
public class CategoryDAOC {
    Connection connection;
    PreparedStatement statement;
    ResultSet resultSet;
    ArrayList<CategoriesC> categoryList;
    ...
    public ArrayList<CategoriesC> getListCategories() {
    ...
    public CategoriesC getCategory(String id) {
        try {
    ...
    public boolean createCategory(CategoriesC category) {
        try {
    ...
    public boolean updateCategory(CategoriesC category) {
        try {
